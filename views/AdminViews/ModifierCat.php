...
if (isset($_POST["libelle"]))
{
    ...
    $response=$catDao->modifierCategorieController($categorie,$libelle);
    $donnee=$catDao->getAllCategorieController();
                ...
                <div class="col-12">
                    <div class="card card-outline">
                        <div class="card-header bg-blue">
                            <h5 class="text-white m-b-0">Modifier Categorie</h5>
                        </div>
                        <div class="card-body">
                            <?php
                            if($response){
                            ...
                            <form method="post" action="ModifierCat.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="libelle" type="text"  required     id="l" class="form-control" placeholder="nom du categorie">
                                </div>
