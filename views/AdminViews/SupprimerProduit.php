...
$response=null;
$donnee=$prodDao->getAllProduitController();
if(isset($_POST['produit'])){
    $produit=$_POST['produit'];
    $response=$prodDao->deleteProduit($produit);
    $donnee=$prodDao->getAllProduitController();
}
?>
<html lang="en">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-angle-right"></i> Supprimer un Produit</li>
            </ol>
        </div>
                ...
                <div class="col-12">
                    <div class="card card-outline">
                        <div class="card-header bg-blue">
                            <h5 class="text-white m-b-0">Supprimer Produit</h5>
                        </div>
                        <div class="card-body">
                            <?php
                            if($response){
                            ...
                            <form method="Post" action="SupprimerProduit.php">
                                <div class="form-group" class="col-lg-6">
                                    <label for="libelle"> Choisir le produit a supprimer </label>
                                    <select name="produit" class="form-control">
                                        <?php
                                        foreach($donnee as $d ){
                                            ?>
                                            <option value="<?php echo $d->getId() ?>"><?php echo $d->getLibelle() ?></option>
                                            <?php
                                        }
                                        ?>
