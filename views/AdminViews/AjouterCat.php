...
if (isset($_POST["libelle"]))
{
    ...
    $catDao->ajouterCategorieController($libelle);
                ...
                <div class="col-12">
                    <div class="card card-outline">
                        <div class="card-header bg-blue">
                            <h5 class="text-white m-b-0">Ajouter Categorie</h5>
                        </div>
                        <div class="card-body">
                            <form method="post" action="AjouterCat.php">
                                <div class="form-group">
                                    <label for="libelle">Libelle</label>
                                    <input name="libelle" type="text"  id="l" required class="form-control" placeholder="nom du categorie">
                                </div>
