...
$donnee=$prodDao->getAllProduitsController();
...
<div class="wrapper boxed-wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu p-ph-res"><a href="#" class="dropdown-toggle"
                                    ...
                                    src="../assets/dist/img/img1.jpg" class="user-image" alt="User Image"> <span
                                    class="hidden-xs">Alexander Pierce</span> </a>
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                <div class="pull-left user-img"><img src="../assets/dist/img/img1.jpg"
                                                                     class="img-responsive" alt="User"></div>
                                <p class="text-left">Florence Douglas
                                    <small>florence@gmail.com</small>
                                </p>
    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel">
                <div class="image text-center"><img src="../assets/dist/img/img1.jpg" class="img-circle"
                                                    alt="User Image"></div>
                <div class="info">
                    <p>Alexander Pierce</p>
                    <a href="#"><i class="fa fa-cog"></i></a> <a href="#"><i class="fa fa-envelope-o"></i></a> <a
                            href="#"><i class="fa fa-power-off"></i></a></div>
            </div>

            <!-- sidebar menu: : style can be found in sidebar.less -->
            <ul class="sidebar-menu" data-widget="tree">
                <li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i> <span>Categorie</span> <span
                ...
                <li class="treeview"><a href="#"> <i class="fa fa-briefcase"></i> <span>Produits</span> <span
                                class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                ...
                <li ><a href="Avis.php"> <i class="fa fa-edit"></i> <span>Avis</span> <span
                                class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>

                </li>
                <li> <a href="Message.php"> <i class="fa fa-table"></i> <span>message</span> <span
                                class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            <h1 class="text-black">Liste des produits</h1>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="sub-bread"><i class="fa fa-angle-right"></i> Pages</li>
                <li><i class="fa fa-angle-right"></i> Liste des produits</li>
            </ol>
        </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover" data-name="cool-table">
                                        ...
                                        foreach($donnee as $d ){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $d->getQuantite() ?></td>
                                                <td><?php echo $d->getMarque() ?></td>
                                                <td><?php echo $d->getReference() ?></td>
                                                <td>
                                                    <span
                                                        <?php
                                                             if($d->getDisponibilite()==1){
                                                ...
                                                <td><?php  echo $d->getCategorie()->getLibelle() ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
    ...
    <footer class="main-footer">
        ...
        <script src="../assets/dist/plugins/datatables/dataTables.bootstrap.min.js"></script>
        <script>
            $(function () {
                $('#example1').DataTable()
                $('#example2').DataTable({
        ...
        <script src="../assets/dist/plugins/table-expo/filesaver.min.js"></script>
        <script src="../assets/dist/plugins/table-expo/xls.core.min.js"></script>
        <script src="../assets/dist/plugins/table-expo/tableexport.js"></script>
        <script>
