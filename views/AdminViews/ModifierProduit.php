            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline">
                        ...
                        <div class="card-body">
                            <form method="get" action="ProduitDetail.php" enctype="multipart/form-data">
                                <div class="form-group" class="col-lg-6">
                                    <label for="libelle"> Choisir le produit a modifier </label>
                                ...
                                <input type="submit" name="submit" value="voir details" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </div>
