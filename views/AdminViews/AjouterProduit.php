...
if (isset($_POST["libelle"]))
{
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            $response=$prodDao->ajouterProduit($categorie,$libelle,$prix,$Description,$Qq,$Marque,$Reference,$dispo,$target_file);
            $donnee=$catDao->getAllCategorieController();
        } else {
           $response="undone";
                        ...
                        <div class="card-body">
                            ...
                            if($response){
                                if($response==="done"){
                                    ...
                                    <div class="form-group has-success">
                                        <label class="control-label" for="inputSuccess1">Ajout avec success</label>
                                    </div>
                                    <?php
                                }else{
                                    ?>
                            ...
                            <form method="post" action="AjouterProduit.php" enctype="multipart/form-data">
                                <div class="form-group" class="col-lg-6">
                                    <label for="libelle"> Choisir la Categorie a modifier </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="libelle" type="text" required  id="l" class="form-control" placeholder="nom du produit">
                                </div>
                                <div class="form-group">
                                    <label for="prix">prix</label>
                                    <input name="prix" type="text" required  id="l" class="form-control" placeholder="prix">
                                </div>
                                <div class="form-group">
                                    <label for="Description">Description</label>
                                    <input name="Description" type="text" required  id="l" class="form-control" placeholder="Description">
                                </div>
                                <div id="error" class="form-group">
                                    <label for="Quantité">Quantité</label>
                                    <input name="Qq" type="text" required onblur="verifieQQ();" id="qq" class="form-control" placeholder="quantité">
                                </div>
                                <div class="form-group">
                                    <label for="Marque">Marque</label>
                                    <input name="Marque" type="text" required  id="l" class="form-control" placeholder="marque">
                                </div>
                                <div class="form-group">
                                    <label for="Reference">Reference</label>
                                    <input name="Reference" type="text" required  id="l" class="form-control" placeholder="reference">
                                </div>
                                    <div class="form-group">
