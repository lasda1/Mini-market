...
<?php
require_once "../../Controllers/Avis.php";
...
$avis=new Avis();
$donnee=$avis->getAllContactController();
$response=null;
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-angle-right"></i> Message</li>
            </ol>
        </div>
                ...
                foreach ($donnee as $d){
                    ...
                    <div class="col-lg-6">
                        <div class="info-box">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="user-img pull-left"> <img src="../assets/dist/img/img1.jpg" class="img-circle img-responsive" alt="User Image"> </div>
                                </div>
                                <div class="col-lg-9">
                                    <div class="mail-contnet">
                                        <h4 class="text-black m-b-0"><?php echo $d['nom_user'] ?></h4>
                                        <p class="m-t-1"><?php echo $d['message'] ?> </p>
                                        <abbr title="mail">email:</abbr> <?php echo $d['email'] ?>
                                    </div>
                                </div>
                            </div>
                        </div>
