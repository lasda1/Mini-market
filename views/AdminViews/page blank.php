    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="active" class="treeview"> <a href="#"> <i class="fa fa-dashboard"></i> <span>Categorie</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li><a href="#">Ajouter une categorie</a></li>
                        <li><a href="#">Modifier une Categorie </a></li>
                        <li><a href="#">Supprimer une categorie</a></li>
                    </ul>
                </li>
                <li class="treeview"> <a href="#"> <i class="fa fa-bullseye"></i> <span>Sous Categories</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li><a href="#">Ajouter une categorie</a></li>
                        <li><a href="#">Modifier une Categorie </a></li>
                        <li><a href="#">Supprimer une categorie</a></li>
                ...
                <li class="treeview"> <a href="#"> <i class="fa fa-envelope-o "></i> <span>Sous sous categories</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li><a href="#">Ajouter une categorie</a></li>
                        <li><a href="#">Modifier une Categorie </a></li>
                        <li><a href="#">Supprimer une categorie</a></li>
                ...
                <li class="treeview"> <a href="#"> <i class="fa fa-edit"></i> <span>Avis</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>

                </li>
                <li class="treeview"> <a href="#"> <i class="fa fa-table"></i> <span>message</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
