...
if (isset($_POST["submit"]))
{
    ...
    $catDao->ajouterOpinion($name,$msg);
...
<div class="global-wrapper clearfix" id="global-wrapper">
    ...
    <div class="container">
        ...
        <div class="row" data-gutter="60">
            <div class="col-md-5">
                <h3 class="widget-title">Leave your opinion here</h3>
                <form method="post" action="Opinion.php">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <input class="btn btn-primary" name="submit" type="submit" value="Send your opinion" />
                </form>
            </div>
         </div>
    </div>
